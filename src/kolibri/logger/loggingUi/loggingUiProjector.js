...
import { projectLoggingChoice, LOGGING_CHOICE_CSS } from "./loggingLevelProjector.js";
/*                                                        ^^^^^^^^^^^^^^^^^^^^^^^^^^^
   TODO cuie: ideally, you only have to change                  this line above
   to integrate your logging level control
*/
...
const LOGGING_UI_CSS = LOGGING_CHOICE_CSS + `
  .logging-ui-config {
      padding:                2rem;
      display:                grid;
